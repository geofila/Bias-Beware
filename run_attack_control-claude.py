...
#     tokenizer, aws_model_id = get_tokenizer_aws_model_id(model_name)
    if model_name == "claude_3_5_sonnet_v2":
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Code for generating an attack.")
    parser.add_argument('--model_name', type=str, required=True, help="The name of the model. Supported models; ['claude_3_5_sonnet_v2']")
